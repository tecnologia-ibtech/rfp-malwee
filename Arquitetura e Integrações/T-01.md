...
A arquitetura da solução Geovendas foi projetada desde sua concepção para operar de forma desacoplada do sistema ERP, utilizando o conceito de múltiplas camadas de abstração que permitem ao SAP funcionar exclusivamente como sistema de faturamento, enquanto toda a gestão de dados mestres e transacionais é realizada por componentes especializados da plataforma.
